        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-6"
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-transparent" style={{backgroundImage: 'linear-gradient(to right, #e6ab3b, #e6ab3b)', WebkitBackgroundClip: 'text', backgroundClip: 'text'}}>
                TARGET 2.0
              </h1>
            </motion.div>

            {/* Single Menu Showcase */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <div className="relative max-w-4xl mx-auto">
                <motion.div
                  ...
                  onMouseMove={(e) => {
                    ...
                    e.currentTarget.style.transform = `perspective(1200px) rotateX(${y * 2}deg) rotateY(${x * 2}deg) translateY(-2px) scale(1.02)`
                  }}
                  onMouseLeave={(e) => {
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href="/signup">
                  <div className="group cursor-pointer border gap-2 h-[60px] flex items-center p-[10px] rounded-full transition-all duration-300" style={{borderColor: '#e6ab3b50', background: 'linear-gradient(to right, #e6ab3b20, #e6ab3b20)'}}>
                    <div className="border h-[40px] rounded-full flex items-center justify-center text-white shadow-lg" style={{borderColor: '#e6ab3b80', background: 'linear-gradient(to right, #e6ab3b, #e6ab3b)', boxShadow: '0 10px 15px -3px #e6ab3b40'}}>
                    ...
                    <div className="group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2" style={{color: '#e6ab3b', borderColor: '#e6ab3b50'}}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <div className="opacity-60 hover:opacity-100 transition-all duration-300">
                  <div className="text-center">
                    <div className="text-2xl font-bold" style={{color: '#e6ab3b'}}>50+</div>
                    <div className="text-xs text-muted-foreground">{t('hero.stats.users')}</div>
                  </div>
                </div>

                <div className="opacity-60 hover:opacity-100 transition-all duration-300">
                  <div className="text-center">
                    <div className="text-2xl font-bold" style={{color: '#e6ab3b'}}>99.9%</div>
                    <div className="text-xs text-muted-foreground">{t('hero.stats.undetected')}</div>
                  </div>
                </div>
